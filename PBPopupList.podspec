...
Pod::Spec.new do |s|
  ...
  s.author             = { "Shahabuddin" => "Shahbuddin@peerbits.com" }
  # Or just: s.author    = "Shahabuddin"
  # s.authors            = { "Shahabuddin" => "Shahbuddin@peerbits.com" }
  # s.social_media_url   = "http://twitter.com/Shahabuddin"
  ...
  s.source       = { :git => "https://github.com/Peerbits/PBToastView.git", :tag => "#{s.version}" }
  ...
  #s.exclude_files = "PBPopupList/Exclude"
